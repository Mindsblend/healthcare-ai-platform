...
export const products: ProductType[] = [
  {
    ...
    description: 'کرم‌ها می‌تونن مواد مفیدی مثل ویتامین‌، یا عصاره‌ گیاهی داشته باشن',
  },
  {
    id: 2,
    title: 'عرق خونساز',
...
{
  id: 7,
  title: 'ماسک صورت خاکی',
  price: 344000,
  image: '/images/product-seven.svg',
  description: 'رفع چربی اضافی و ایجاد لطافت با خواص پاک‌کننده گیاهی',
},
]
