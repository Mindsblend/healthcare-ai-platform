...
export default function AI() {
  return (
    <div className="flex flex-col items-center justify-center px-20 text-center">
      <h1 className="font-aria text-color-title-on-light mt-12 max-w-[756px] text-[64px] leading-20 font-extrabold">
        رمز انرژی و تعادل بدنت رو همین حالا پیدا کن
      </h1>
      <p className="font-ray font-regular text-color-body-on-light mt-4 max-w-[613px] text-[18px]">
      ...
      <div className="mt-4 flex flex-row items-center justify-center gap-12">
        ...
        <div className="flex flex-col items-center justify-center">
          <h1 className="font-aria flex items-center justify-center text-[54px] leading-[58px] font-bold">
            ۵۰۰
          </h1>
      ...
      <button className="mt-6 flex h-[54px] w-[210px] cursor-pointer items-center justify-between rounded-full bg-black px-3 text-white">
        {/* Button text */}
