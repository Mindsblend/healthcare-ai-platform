      ...
      <div className="container mt-14 xl:mt-28">
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="font-ray text-color-title-on-light mt-5 max-w-xl text-xs sm:text-sm xl:text-lg">
            زندگی روزمره پر از فشار، تغذیه ناسالم و استرس‌های پنهان است که اغلب
            ما متوجه اثرات آن بر بدن و ذهن‌مان نمی‌شویم. این صفحه برای شما ساخته
            شده تا با ارائه مقالات علمی، توصیه‌های عملی و راهکارهای
