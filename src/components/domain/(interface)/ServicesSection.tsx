  ...
  return (
    <div className="mt-12 flex flex-col items-center justify-center">
      ...
      <div className="mt-14 grid w-full grid-cols-1 flex-wrap sm:grid-cols-2 lg:grid-cols-4">
        {/* Fast Delivery */}
        <div className="flex h-65 flex-col justify-between border-t-2 border-dashed border-black px-8 pt-6 pb-5 sm:border-l-2 xl:h-84.25 xl:pb-16">
          <Image
            src="/images/delivery.svg"
            alt="delivery_truck"
            width={70}
            height={70}
            className="w-[50] xl:w-17.5"
          />
          <div className="text-color-title-on-light">
            <h1 className="font-ray text-lg font-extrabold xl:text-xl">
              ارسال سریع و مطمئن
            </h1>
            <p className="text-color-body-on-light font-ray mt-2.5 max-w-66.5 text-sm xl:text-lg">
        ...
        <div className="flex h-65 flex-col justify-between border-t-2 border-dashed border-black px-8 pt-6 pb-5 sm:border-l-2 xl:h-84.25 xl:pb-16">
          ...
          <div className="text-color-title-on-light">
            ...
            <p className="text-color-body-on-light font-ray max-w-66.55 mt-2.5 text-sm xl:text-lg">
        ...
        {/* Easy Payment */}
        <div className="flex h-65 flex-col justify-between border-t-2 border-dashed border-black px-8 pt-6 pb-5 xl:h-84.25 xl:pb-16">
          <Image
            src="/images/card.svg"
            alt="credit_card"
            width={70}
